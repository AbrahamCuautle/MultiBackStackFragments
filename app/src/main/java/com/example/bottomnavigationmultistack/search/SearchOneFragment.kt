...
import com.example.bottomnavigationmultistack.cart.CartTwoFragment
 ...
 * Use the [SearchOneFragment.newInstance] factory method to
...
class SearchOneFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnSearchOne.setOnClickListener {
            fragmentManager?.beginTransaction()?.run {
                replace(R.id.searchContainer, SearchTwoFragment(), SearchTwoFragment.TAG)
                addToBackStack(SearchTwoFragment.TAG)
                commit()
            }
        }
    }
    ...
    companion object {
        ...
        val TAG = SearchOneFragment::class.java.canonicalName

        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SearchOneFragment().apply {
