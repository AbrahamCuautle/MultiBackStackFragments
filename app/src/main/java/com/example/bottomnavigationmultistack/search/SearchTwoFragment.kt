 ...
 * Use the [SearchTwoFragment.newInstance] factory method to
...
class SearchTwoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SearchTwoFragment.
         */
        // TODO: Rename and change types and number of parameters

        val TAG = SearchTwoFragment::class.java.canonicalName

        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SearchTwoFragment().apply {
